...
const Sorcerer = () => {
    const img = 'https://static1.thegamerimages.com/wordpress/wp-content/uploads/2019/10/pjimage-40.jpg';
    return (
    <div className = "profileInfo">
        <img src = "../Images/sorcerer.jpg" className = "characterPic" alt = "A Wizard" />
