...
const Cleric = () => {
    const img = 'https://arcaneeye.com/wp-content/uploads/2020/05/44c5b20b0c03e0ef32772cf2a1a95b4c-769x481.jpg';

    return (
        <div className = "profileInfo">
            <img src = "../Images/cleric.jpg" className = "characterPic" alt = "A Cleric" />
